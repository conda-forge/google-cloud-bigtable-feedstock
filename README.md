...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/google-cloud-bigtable-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/google-cloud-bigtable-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add google-cloud-bigtable
# for installing globally
pixi global install google-cloud-bigtable
```
...
It is possible to list all of the versions of `google-cloud-bigtable` available on your platform:
...
```
pixi search google-cloud-bigtable --channel conda-forge
```
