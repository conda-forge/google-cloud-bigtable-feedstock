...
validate_recipe_outputs "google-cloud-bigtable-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="google-cloud-bigtable-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi